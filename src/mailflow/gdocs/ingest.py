...
from mailflow.gdocs.client import GoogleClient
from mailflow.gdocs.storage import DocsArchivePaths, write_md, write_pdf
...
def _base_dir(cfg: Config) -> str:
    ...
    return s.get("base_dir", "~/Documents/mailflow")
