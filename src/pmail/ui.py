...
class WorkflowSelector:
    ...
    def select_workflow(self, email_data: dict) -> Optional[str]:
        ...
        if selected_workflow:
            ...
            instance = CriteriaInstance(
                ...
                user_confirmed=True,
                confidence_score=rankings[0][1] if rankings and rankings[0][0] == selected_workflow else 0.0
            )
    ...
    def _create_new_workflow(self) -> Optional[str]:
        ...
        action_types = ["flag", "save_attachment", "copy_to_folder", "create_todo", "custom"]
        ...
        if action_type == "flag":
            ...
            dir_input = LineInput("Directory", typical=["~/Downloads", "~/Documents"])
            action_params["directory"] = dir_input.ask()
            pattern_input = LineInput("File pattern", typical=["*.pdf", "*.*"])
