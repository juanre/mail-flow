"""Interactive setup utility for pmail.

This wizard helps you create/update ~/.pmail/config.json and optionally
...
def main():
    ...
    click.echo("\nAll done! You can now run:\n  pmail init\n  uv run pmail gmail --query 'label:INBOX'\n  uv run pmail msearch 'invoice'\n")
