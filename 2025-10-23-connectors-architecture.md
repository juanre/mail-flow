      ...
      content/
        mailflow/
          {workflow}/             # e.g., jro-expense, jro-tax, jro-doc
            {YYYY}/{MM}/...
            attachments/{YYYY}/{MM}/...
            raw_email/{YYYY}/{MM}/... (optional)
        slack/
          md/{channel}/YYYY-MM-DD.md
          raw/{channel}/YYYY-MM-DD.json
          attachments/{channel}/...
        gdocs/
          {folder_hint}/...
        localdocs/
          ...
      metadata/
        mailflow/{workflow}/YYYY/{MM}/...json
        slack/{channel}/...json
        gdocs/...json
        localdocs/...json
      indexes/
...
- Content is organized per entity and per workflow (for mailflow) to preserve business semantics such as receipts, invoices, tax documents, etc.
...
A single JSON schema governs all connectors. An example for mailflow-produced documents:

```jsonc
{
  "id": "mailflow=jro-expense/2025-10-23T13:45:01Z/sha256:abc...",
  "entity": "jro",
  "source": "mailflow",
  ...
  "content": {
    "path": "../content/mailflow/jro-expense/2025/10/acme_receipt.pdf",
    "hash": "sha256:abc...",
    "size_bytes": 123456,
    "mimetype": "application/pdf",
    "attachments": [
      "../content/mailflow/jro-expense/attachments/2025/10/acme_logo.png"
    ]
  },
  "tags": ["workflow:jro-expense", "mailflow", "receipt"],
  "relationships": [
    {
      "type": "derived_from_email",
      "target_id": "mailflow=email/2025-10-23T13:45:01Z/sha256:def..."
    }
  ],
  "ingest": {
...
- `RepositoryWriter` writes to `content/mailflow/{workflow}/...` and emits metadata under `metadata/mailflow/{workflow}/...`.
- `processed_emails_tracker` records the metadata `id` to maintain idempotency.
- Optional raw email storage (`raw_email/{YYYY}/{MM}`) preserves `.eml` files for legal/audit needs.
...
- Sanitize filenames, handle collisions via hashes, and create year/month subdirectories.
- Write content atomically (tmp → rename) and compute hashes.
...
2. **Mailflow Refactor**
   ...
   - Map existing workflow directories (e.g., `~/Documents/mailflow/jro/expense`) to the new repo path.
