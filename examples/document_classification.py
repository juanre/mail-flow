#!/usr/bin/env python
"""
Example of using document classification and metadata extraction with mailflow.
...
from mailflow.metadata_store import MetadataStore, DocumentType, DocumentCategory


def main():
    # Create a test directory
    test_dir = Path("/tmp/mailflow_example")
    ...
    doc_info = store.get_document_info("<invoice-123@amazon.com>", "2024-01-15-amazon-invoice.pdf")
